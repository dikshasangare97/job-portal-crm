            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Job Role</span>
                    </div>
                </li>
            </ol>
        </nav>
        <h2 class="mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900">Job Role</h2>
        ...
        <div class="flex">
            <div class="w-full">
                <div class="flex m-2">
                    ...
                    <div class="w-1/6">
                        <div class="mt-5">
                            <a href="/admin/jobrole/create" class="mt-3 p-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                                Add Job Role
                            </a>
                        </div>
                    </div>
                ...
                <div class="">
                        ...
                        <table class="min-w-max w-full table-auto border">
                            <thead>
                                <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                    <th class="py-3 px-6 text-left">Role Category</th>
                                    <th class="py-3 px-6 text-left">Job Role Name</th>
                            ...
                            <tbody class="text-gray-600 text-sm font-light">
                                ...
                                <tr class="border-b border-gray-200 hover:bg-gray-100 font-normal" wire:key="{{$jobrole->id}}">
                                    <td class="py-3 px-6 text-left">
                                        <div class="flex items-center">
                                            <span>{{$jobrole->roleCategory->role_name}}</span>
                                        </div>
                                    </td>
                                    <td class="py-3 px-6 text-left">
                                        <div class="flex items-center">
                                            <span>{{$jobrole->job_role_name}}</span>
                                        </div>
                                    </td>
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex item-center justify-center">
                                            <button wire:click="show({{$jobrole->id}})" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                                </svg>
                                            </button>
                                            <button wire:click="edit({{$jobrole->id}})" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                                </svg>
                                            </button>
                                            <button onclick="return confirm('Are you sure you want to delete this item?') || event.stopImmediatePropagation()" wire:click="delete({{$jobrole->id}})" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="fixed inset-0 flex items-center justify-center z-50">
                        ...
                        <div class="relative bg-gray-200 p-8 rounded shadow-lg w-1/2">
                            ...
                            <form enctype="" wire:submit.prevent="{{ $jobroleId ? 'update' : '' }}">
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="status" id="status" class="rounded-full text-xs">
                                        <option value="1" class="bg-green-200 text-green-600 py-1 font-medium px-3 rounded-full" @if($jobrole->status == 1) @endif>Available</option>
                                        <option value="0" class="bg-red-200 text-red-600 py-1 font-medium px-3 rounded-full" @if($jobrole->status == 0) @endif>Not available</option>
                                    </select>
