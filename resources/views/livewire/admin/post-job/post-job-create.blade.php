<div class="px-4 py-5 bg-white rounded-lg border">
    ...
    <h2 class="mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900">Create a new job</h2>
            ...
            <form wire:submit="store">
                ...
                <div class="flex">
                    ...
                    <div class="w-full xl:w-1/3 lg:w-1/2 md:w-1/2 mb-6 ml-2">
                        ...
                        <br>
                        <input type="text" class="text-sm sm:text-base placeholder-gray-500 mt-2 pl-3 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" wire:model="vacancy" id="vacancy">
