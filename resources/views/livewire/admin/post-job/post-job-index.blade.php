                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-100" wire:key="{{$job->id}}">
                                ...
                                <td class="py-3 px-6 text-start">
                                    <div class="flex item-start justify-start">
                                        <a href="/admin/job/{{$job->id}}/view" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                        ...
                                        <a href="/admin/job/{{$job->id}}/edit" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
