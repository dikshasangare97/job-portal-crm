            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Job Listing</span>
                    </div>
                </li>
            </ol>
        </nav>
        <h2 class="mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900">Job Listing</h2>
        ...
        <div class="flex">
            <div class="w-full">
                <div class="flex m-2">
                    ...
                    <div class="w-1/6">
                        <div class="mt-5">
                            <a href="/admin/post-job/create" class="p-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                                Post a job
                            </a>
                        </div>
                    </div>
                    ...
                    <table class="min-w-max w-full table-auto border">
                        <thead>
                            <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                <th class="py-3 px-6 text-left">Job Headline</th>
                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            @if($jobs)
                            @foreach($jobs as $job)
                            <tr class="border-b border-gray-200 hover:bg-gray-100" wire:key="{{$job->id}}">
                                <td class="py-3 px-6 text-left">
                                    <div class="flex items-center font-semibold">
                                        <span>{{$job->job_headline}}</span>
                                    </div>
                                </td>
                                <td class="py-3 px-6 text-left">
                                ...
                                <td class="py-3 px-6 text-start">
                                    <div class="flex item-start justify-start">
                                        <button wire:click="show({{$job->id}})" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                        ...
                                        <button wire:click="edit({{$job->id}})" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                            </svg>
                                        </button>
                                        <button wire:click="deleteJob({{ $job->id }})" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110" onclick="return confirm('Are you sure you want to delete this item?') || event.stopImmediatePropagation()" >
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
