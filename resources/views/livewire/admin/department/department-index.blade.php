                ...
                <div class="">
                                ...
                                <tr class="border-b border-gray-200 hover:bg-gray-100 font-normal" wire:key="{{$department->id}}">
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex item-center justify-center">
                                            ...
                                            <button wire:click="edit({{$department->id}})" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                                </svg>
                                            </button>
                                            <button onclick="return confirm('Are you sure you want to delete this item?') || event.stopImmediatePropagation()" wire:click="delete({{$department->id}})" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="fixed inset-0 flex items-center justify-center z-50">
                        ...
                        <div class="relative bg-gray-200 p-8 rounded shadow-lg w-1/2">
                            ...
                            <form enctype="" wire:submit.prevent="{{ $departmentId ? 'update' : '' }}">
                                <div class="mb-4">
