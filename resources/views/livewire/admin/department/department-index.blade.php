            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Department</span>
                    </div>
                </li>
            </ol>
        </nav>
        <h2 class="mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900">Department</h2>
        ...
        <div class="flex">
            <div class="w-full">
                <div class="flex m-2">
                    ...
                    <div class="w-1/6">
                        <div class="mt-5">
                            <a href="/admin/department/create" class="p-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                                Add Department
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="rounded my-6">
                        <table class="min-w-max w-full table-auto border">
                            ...
                            <tbody class="text-gray-600 text-sm font-light">
                                ...
                                <tr class="border-b border-gray-200 hover:bg-gray-100 font-normal" wire:key="{{$department->id}}">
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex item-center justify-center">
                                            <!-- <button wire:click="show({{$department->id}})" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                                </svg>
                                            </button> -->
                                            <button wire:click="edit({{$department->id}})" class="w-4 mr-2 transform hover:text-blue-500 hover:scale-110">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                                </svg>
                                            </button>
                                            <button onclick="return confirm('Are you sure you want to delete this item?') || event.stopImmediatePropagation()" wire:click="delete({{$department->id}})" class="w-4 mr-2 transform hover:text-red-500 hover:scale-110">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                @else
                                <tr>
                                    <td>No department detail found</td>
                                </tr>
                                @endif
                            </tbody>
                        </table>
                ...
                <div class="fixed inset-0 flex items-center justify-center z-50">
                    ...
                    <div class="relative p-3 bg-white rounded shadow-lg w-1/2">
                        <div class="flex">
                            <div class="w-2/3">
                                <h1 class="p-5 items-center font-semibold tracking-wide text-gray-900 leading-8 text-xl">Edit Department Detail</h1>
                            </div>
                            <div class="w-1/3">
                                <div class="p-5">
                            ...
                            <div class=" relative">
                                <div class="p-6 space-y-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" wire:model="department_name" id="department_name" class="w-full border border-gray-300 px-4 py-2 rounded">
                                        <div class="text-xs text-red-600 font-semibold pt-1">@error('department_name') {{ $message }} @enderror</div>
                                    </div>
                                    <div class="mb-4">
