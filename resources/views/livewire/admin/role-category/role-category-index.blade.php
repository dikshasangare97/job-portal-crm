            ...
            <div class="w-full">
                                ...
                                <tr class="border-b border-gray-200 hover:bg-gray-100 font-normal" wire:key="{{$role->id}}">
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex item-center justify-center">
                                            ...
                                            <button onclick="return confirm('Are you sure you want to delete this item?') || event.stopImmediatePropagation()" wire:click="delete({{$role->id}})" class="w-4 mr-2 transform hover:text-red-500 hover:scale-110">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="fixed inset-0 flex items-center justify-center z-50">
                    ...
                    <div class="relative p-3 bg-white rounded shadow-lg w-1/2">
                        <div class="flex">
                            <div class="w-2/3">
                                <h1 class="p-5 items-center font-semibold tracking-wide text-gray-900 leading-8 text-xl">Edit Role Category Detail</h1>
                            </div>
                            <div class="w-1/3">
                                <div class="p-5">
