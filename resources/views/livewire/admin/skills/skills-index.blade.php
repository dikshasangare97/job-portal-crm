    ...
    <div class="flex">
        <div class="w-full">
            <div class="flex m-2">
                ...
                <div class="w-1/6">
                    <a href="/admin/skills/create" class="mt-3 p-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Add Skills
                    </a>
                </div>
            </div>
                           ...
                           <path d="M14.53 4.53l-1.06-1.06L9 7.94 4.53 3.47 3.47 4.53 7.94 9l-4.47 4.47 1.06 1.06L9 10.06l4.47 4.47 1.06-1.06L10.06 9z" />
                            ...
                            <h2 class="text-2xl font-bold mb-4"></h2>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" wire:model="key_skill_name" id="key_skill_name" 
