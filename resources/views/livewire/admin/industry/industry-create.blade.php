<div class="px-4 py-5 bg-white rounded-lg border">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="/admin/industry" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2">Industry</a>
                </div>
            </li>
    ...
    <h2 class="mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900">Create a new industry</h2>
