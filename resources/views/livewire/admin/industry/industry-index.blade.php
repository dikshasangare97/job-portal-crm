<div class="mt-0">
    <div class="m-2">
        ...
        <div class="bg-green-100 border-l-4 border-green-500 text-green-700 p-4" industry="alert">
            <p class="font-bold text-xs">{{ session('message') }}</p>
        </div>
        @endif
        @if (session()->has('error'))
        <div class="bg-red-100 border-l-4 border-red-500 text-red-700 p-4" industry="alert">
    ...
    <div class="flex">
        <div class="w-full">
            <div class="flex m-2">
                ...
                <div class="w-1/6">
                    <a href="/admin/industry/create" class="mt-3 p-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Add industry
                    </a>
                </div>
            </div>
                ...
                <div class=" shadow-md rounded my-6">
                    <table class="min-w-max w-full table-auto">
                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-100" wire:key="{{$industry->id}}">
                           ...
                           <path d="M14.53 4.53l-1.06-1.06L9 7.94 4.53 3.47 3.47 4.53 7.94 9l-4.47 4.47 1.06 1.06L9 10.06l4.47 4.47 1.06-1.06L10.06 9z" />
                            ...
                            <h2 class="text-2xl font-bold mb-4"></h2>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" wire:model="industry_name" id="industry_name" 
