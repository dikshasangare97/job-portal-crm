<div class="bg-white p-5 shadow-sm rounded-xl">
    ...
    <div>
        ...
        <div class="flex items-center p-4 mb-4 text-sm text-red-800 border-b border-red-700" role="alert">
            ...
            <div>
                ...
                <span class="text-gray-600 font-semibold leading-6">{{ session('keyskillmsgerror') }}</span>
            </div>
        </div>
        @endif
    </div>
    ...
    <div class="my-3">
        ...
        <div class="m-1 inline-flex max-w-96">
            <span class="font-normal text-sm rounded-full border border-gray-500 px-3 py-2 text-gray-600">{{$userKeySkill->keySkill->key_skill_name}}</span>
        </div>
        @endforeach
        @endif
    </div>
                    ...
                    <div class="px-5 pb-2">
                        ...
                        <div>
                            ...
                            <div class="my-2">
                                @if($userKeySkills)
                                @foreach($userKeySkills as $userKeySkill)
                                <div class="inline-flex max-w-96">
                                    <span class="font-normal text-xs rounded-full border border-gray-500 px-3 py-2 text-gray-600">{{$userKeySkill->keySkill->key_skill_name}}</span>
                                </div>
                                @endforeach
                                @endif
                            </div>
