                        ...
                        <div class="flex">
                            ...
                            <div class="w-full md:w-1/2 pl-3">
                                ...
                                <div class="flex text-sm  text-slate-500 font-normal py-2">
                                    ...
                                    <p>{{ $userEmployment->notice_period ?? '-' }} notice period</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="px-5 pb-2">
                        ...
                        <div class="my-3 flex">
                            <div class="w-full mr-2">
                                ...
                                <br>
                                <input type="text" wire:model="company_name" id="company_name" class="text-xs placeholder-gray-500 mt-2 pl-3 pr-4 rounded-lg border border-gray-400 w-full py-2 " placeholder="Name" value="{{ Auth::user()->name }}" />
                                <div class="text-xs text-red-600 font-bold">@error('company_name') {{ $message }} @enderror</div>
                            </div>
                        </div>
                        ...
                        <div class="my-3">
                            ...
                            <br>
                            <input type="hidden" wire:model="salary" readonly value="India">
                            <input type="text" wire:model="salary" id="salary" class="text-xs placeholder-gray-500 mt-2 pl-3 pr-4 rounded-lg border border-gray-400 w-full py-2 " placeholder="Current location" />
                            <div class="text-xs text-red-600 font-bold">@error('salary') {{ $message }} @enderror</div>
                        </div>
