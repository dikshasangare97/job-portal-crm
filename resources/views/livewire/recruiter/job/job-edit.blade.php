                ...
                <form wire:submit="update">
                    ...
                    <div class="flex">
                        <div class="w-1/3 mb-6">
                            ...
                            <br>
                            <input type="text" class="text-sm sm:text-base placeholder-gray-500 mt-2 pl-3 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" wire:model="key_skill" id="key_skill" placeholder="Type key skills">
